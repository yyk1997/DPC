...
if args.dataset != 'ember':
    ...
    print(f"Will save to '{os.path.join(poison_set_dir, 'DP_ct_cleansed_full_base_aug_seed=%d.pt' % args.seed)}")
    ...
    if args.dataset != 'ember':
        if epoch % 5 == 0:
            if args.dataset == 'imagenet':
                ...
                torch.save(model.module.state_dict(), os.path.join(poison_set_dir, 'DP_ct_cleansed_full_base_aug_seed=%d.pt' % args.seed))
    else:
        if epoch % 5 == 0:
